                            ...
                            <ul class="nav nav-pills nav-justified steps">
                                <li>
                                    <a href="#tab1" data-toggle="tab" class="step">
                                        ...
                                        <span class="desc">
                                            <i class="fa fa-check"></i> dit scherm heeft onderverdelingen naargelang de keuze voor kunststof, aluminium of hout 
                                        </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#tab2" data-toggle="tab" class="step">
                                        ...
                                        <span class="desc">
                                            <i class="fa fa-check"></i> Deze schermen indien voor Kunststof wordt gekozen 
                                        </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#tab3" data-toggle="tab" class="step active">
                                        ...
                                        <span class="desc">
                                            <i class="fa fa-check"></i> Deze schermen indien voor Aluminium wordt gekozen 
                                ...
                                <li>
                                    <a href="#tab4" data-toggle="tab" class="step">
                                        ...
                                        <span class="desc">
                                            <i class="fa fa-check"></i> Deze schermen indien voor hout wordt gekozen 
                                        </span>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="#tab4" data-toggle="tab" class="step">
                                        <span class="number"> 4 </span>
                                        <span class="desc">
                                            <i class="fa fa-check"></i> Step 6 </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#tab4" data-toggle="tab" class="step">
                                        <span class="number"> 4 </span>
                                        <span class="desc">
                                            <i class="fa fa-check"></i> Step 7 </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#tab4" data-toggle="tab" class="step">
                                        <span class="number"> 4 </span>
                                        <span class="desc">
                                            <i class="fa fa-check"></i> Step 8 </span>
                                    </a>
                                </li>
                            </ul>
