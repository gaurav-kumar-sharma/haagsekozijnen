...
<div class="row" style="margin-top:2%;">
    ...
    <div class="col-sm-4">
        ...
        <div class="row">
            ...
            <form class="form-horizontal" method="get" action="/homepage/aluminium_steellook">
                <div class="row" style="margin-bottom:1%;">
                    ...
                    <div class="col-sm-5" required="true" >
                        ...
                        <?php } else { ?>
                            <input type="number" name="breedle" value="80" class="form-control" required/>
                        <?php } ?>
                    </div>
                </div>
                <div class="row" style="margin-bottom:1%;">
                    ...
                    <div class="col-sm-5" required="true" style="position: static;">
                        ...
                        <?php } else { ?>
                            <input type="number" name="hoogte" value="80" class="form-control"  required/>
                        <?php } ?>
                    </div>
                </div>
        ...
        <div class="row">
            <div style="float:left; width:100%;">
                <div style="width:<?php echo $width; ?>; height:4px; border: 10px solid transparent; border-image:url(/img/arrow-hor.png); border-image-repeat: stretch; border-bottom:0;    
                     border-image-slice: 30; border-style:inset;margin-bottom:8px;  "> <div style="margin:-17px auto 0 auto; background:#FFF; display:block; padding:5px 10px; text-align:center; font-size:12px; width:100px"><?php echo $width; ?></div>
                </div>
                <div id="frame" style="text-align:center;border:0;box-shadow:0 0 0 5px <?php echo $kleur_buit; ?>; width:<?php echo $width; ?>;height:<?php echo $height; ?>;float:left;">
                </div>
...
<script>
    jQuery(document).ready(function($) {
        ...
        $('#set_frame_dim_form').submit(function(e) {
            ...
            console.log(framId);
            $("#" + framId).width($("#frame_breedle").val() + "mm").height($("#frame_hoogte").val() + "mm");
