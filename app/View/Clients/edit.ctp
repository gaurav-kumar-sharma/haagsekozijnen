                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <?php echo $this->Form->input('datum', array('label' => false, 'class' => 'form-control', 'type' => 'text', 'id' => 'datum','value'=>date('m/d/Y', strtotime($this->request->data['Client']['datum'])), 'required')); ?><br>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php echo $this->Form->input('ref_number', array('class' => 'form-control', 'readonly', 'label' => false,  'required')); ?><br>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php echo $this->Form->input('user_id', array('class' => 'form-control', 'label' => false, 'type' => 'select',  'required')); ?><br>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php echo $this->Form->input('email_user', array('class' => 'form-control', 'type' => 'email','label' => false, 'required')); ?><br>
                        </div>
                    </div>
                    <div class="form-group">
