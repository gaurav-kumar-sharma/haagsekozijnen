...
<html lang="en">
    ...
    <head>
        ...
        <!-- BEGIN THEME STYLES -->
        <?php echo $this->Html->css('/assets/global/css/components-rounded.css', array('id' => 'style_components')); ?>
        <?php echo $this->Html->css('/assets/global/css/plugins.css'); ?>
        <?php echo $this->Html->css('/assets/admin/layout/css/layout.css'); ?>
        <?php echo $this->Html->css('/assets/admin/layout/css/themes/default.css', array('id' => 'style_color')); ?>
    ...
    <body class="login">
        ...
        <div class="logo">
           ...
           -->
            <?php //echo $this->Html->image('companyImage.jpg'); ?>
            </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
